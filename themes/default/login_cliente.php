...
if (!empty($data)) {
   ...
   // var_dump($data);
    ...
    $verusu->ExeRead("app_clientes", "WHERE nome = :a AND cpf = :b OR cnpj = :b ", "a={$data['nome']}&b={$data['password']}");
    $verusu->getResult();
   ...
   // var_dump($verusu);
    if ($verusu->getResult()) {
        ...
        $_SESSION['nivel'] = 1;
        $_SESSION['cliente_id'] = $verusu->getResult()[0]["cliente_id"];
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <?php } ?>
                            <?php // $message;  ?>
                            <form action="<?= CONF_URL_BASE ?>/entrar_cliente" id="cadastro" name="form" method="post">
                                <div class="form-group mb-3">
                                    <input  type="text" name="nome" placeholder="Seu Nome" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                </div>
                                <div class="form-group mb-3">
                                    <input  type="password" name="password" placeholder="Senha" required="" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary">
                                </div>
