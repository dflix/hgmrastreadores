...
//pega o Dominio e o nome do arquivo
        if($xmlreq['post_category'] == "pagina"):
            ...
            $conteudo .="     <loc>http://".HOME."/". $xmlreq['post_name']. "</loc>"."\n";
            else:
            $conteudo .="     <loc>http://".HOME."/". $xmlreq['post_category']."/".$xmlreq['post_name']. "</loc>"."\n";
        endif;

//pega a data atual e informa no xml
$conteudo .= '     <lastmod>'.date('Y-m-d', strtotime($xmlreq['post_date'])).'</lastmod>'."\n";
//informa a frequencia de atualização da pagina
