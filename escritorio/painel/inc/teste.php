...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=teste&ano={$ano}&mes={$mes}&dia={$dia}\"> ";
//header("location:index.php?p=fluxocaixa&ano={$ano}");
endif;
?>
<main class="content"> 
    <h3 class="page-header"> MANUTENÇÕES E RETIRADAS </h3>
    <section class="row col-md-12"> 
        <form action="index.php?p=teste" class="form" method="GET">
            ...
            <div class="col-md-2"> 
                ...
                <input type="submit" name="p" value="teste" class="btn btn-primary" /> </div>
            <div class="clear"> </div>
        </form>
    </section>
    ...
    <section class="col-md-12"> 
        ...
        <div class="page-header"> TESTES MENSAL </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">TICKET # <?= $valueprot['id'] ?> - PROTOCOLO <?= $valueprot['protocolo'] ?> </h4>
                                </div>
