...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=estatisticaporvendedor&ano={$ano}&mes={$mes}&dia={$dia}&view=resultados\"> ";
...
<section class="row col-md-12"> 
        <form action="" class="form" metdod="GET">
            ...
            <div class="col-md-3"> 
                ...
                <input type="submit" name="p" value="estatisticaporvendedor" class="btn btn-primary" /></div>
            <div class="clear"> </div>
        </form>
    </section>
