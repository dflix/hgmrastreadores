...
//string json contendo os dados de um funcionário
        ...
        <div class="form-group col-md-3"> 
            <p>Modelo </p>
            <select name="modelo1" class="form-control"> </select>

        </div>
        
        <div class="form-group col-md-2"> 
            <p>Ano </p>
            <select name="ano1" class="form-control"> </select>

        </div>
        
        <div class="form-group col-md-2"> 
            <p>Fipe </p>
            <select name="fipe1" class="form-control"> </select>
        </div>
        
        <div class="form-group col-md-2"> 
            <p>Valor </p>
            <select name="valor1" class="form-control" > </select>
        </div>
