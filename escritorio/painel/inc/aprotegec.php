...
foreach ($enviados->getResult() as $value) {
    ...
    echo "<a href=\"../documentos/{$value['doc']}\" target=\"blank\"> <img src=\"../documentos/{$value['doc']}\" width=\"200\" style=\"float: left; margin-left:5px;\" /></a>";
}
?>

    <div class="clear"> . </div>
    
    <button class="botao arruma"> <a href="index.php?p=eprotege" class="arruma">FINALIZAR ATUALIZAÇAO</a>  </button>
