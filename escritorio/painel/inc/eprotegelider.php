...
<section class="row"> 
        ...
        <div class="col-md-12"> 
            ...
            <form action="index.php?p=eprotegelider" name="buscar" method="POST" class="form-responsive form-inline" enctype="multipart-form/data">
...
if (isset($filtro)) {
    ...
    <table class="table-responsive table-bordered ">
        ...
        <tbody>
            ...
            $pager = new Pager('index.php?p=eprotegelider&atual=', 'Primeira', 'Ultima', '1');
            ...
            if ($_COOKIE['logprot_nivel'] == "2"):
                ...
                $exibe = new Read();
                $exibe->ExeRead("prevenda", "WHERE {$filtro['filtro']} LIKE '%' :link '%' AND realcionado = :r", "link={$filtro['q']}&r={$_COOKIE['logprot_id_usuario']}");
                $exibe->getResult();
        ...
        <!--                    <td><p class="botao2"><a href="index.php?p=dados&id=<?= $value['placa'] ?>" class="arruma" target="_blank" >TODOS<br>
                    ...
                    <td>
                        ...
                        <p> <a  href="index.php?p=ttprotege&id=<?= $value['id_venda'] ?>"><span class="glyphicon glyphicon-user">Titularidade</span></a> </p>

                        <hr>
                        <p> <a  href="index.php?p=tprotege&id=<?= $value['id_venda'] ?>"><span class="glyphicon glyphicon-road">Veículo</span></a> </p>

                        <hr>

                        <p class="botaoimpresso"> <a class="glyphicon glyphicon-file" href="transferencia.php?id=<?= $value['id_venda'] ?>" target="blank">Titularidade</a> </p>

                        <hr>

                        <p class="botaoimpresso"> <a class="glyphicon glyphicon-file" href="transferencia.php?id=<?= $value['id_venda'] ?>&veiculo=sim" target="blank">Veiculo</a> </p>
                    </td>
                    <td>

                        <p class="botaoimpresso"> <a class="glyphicon glyphicon-file" href="adesao.php?id=<?= $value['id_venda'] ?>" target="blank">Adesão</a> </p>

                        <hr>

                        <p class="botaoimpresso"> <a class="glyphicon glyphicon-file" href="vistoria.php?id=<?= $value['id_venda'] ?>" target="blank">Vistoria</a> </p>
                    ...
                    <td> 
                        ...
                        <p> <a class="glyphicon glyphicon-file" href="contrato-moto.php?id=<?= $value['id_venda'] ?>" target="blank">Contrato Moto</a> </p>
                        <hr>

                        <p> <a class="glyphicon glyphicon-file" href="contrato.php?id=<?= $value['id_venda'] ?>" target="blank">Contrato 5%</a> </p>
                        <hr>
                        <p> <a class="glyphicon glyphicon-file" href="contrato10.php?id=<?= $value['id_venda'] ?>" target="blank">Contrato 10%</a> </p>

                        <hr>
                        <p > <a class="glyphicon glyphicon-file" href="contrato50.php?id=<?= $value['id_venda'] ?>" target="blank">Contrato 15%</a> </p>
                    ...
                    if ($verdoc->getResult()) {
                        ?>
                        <td><a href="index.php?p=upload&id_venda=<?= $value['id_venda'] ?>" target="blank"><span class="glyphicon glyphicon-file" style="font-size:25px;"> </span> </a></td>

                    <?php } else { ?>

                        <td><p class="botao2 arruma"> <a href="index.php?p=upload&id_venda=<?= $value['id_venda'] ?>" target="blank" class="arruma">Enviar Doc </a> </p></td>
    ...
    <table class="table-responsive table-bordered ">
        ...
        <tbody>
            ...
            if ($_SESSION['nivel'] == "2"):
                ...
                $exibe = new Read();
                $exibe->ExeRead("prevenda", "WHERE vendedor = :v ORDER BY data DESC LIMIT :limit OFFSET :offset", "v={$_SESSION['id_usuario']}&limit={$pager->getLimit()}&offset={$pager->getOffset()}");
                $exibe->getResult();

            else:
                $exibe = new Read();
                $exibe->ExeRead("prevenda", "WHERE relacionado = :r ORDER BY data DESC LIMIT :limit OFFSET :offset", "r={$_SESSION['id_usuario']}&limit={$pager->getLimit()}&offset={$pager->getOffset()}");
                $exibe->getResult();
