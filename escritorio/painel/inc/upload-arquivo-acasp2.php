...
<main> 
    ...
    <label class="quarenta"> 
        <p class="background"> MARCA MODELO </p>
    ...
    <label class="setenta"> 
        <p class="background"> Mensalidade Associação </p>
...
<!--    <section class="col-md-12"> 
        ...
        <div class="thumbnail col-md-3"> <span class="glyphicon glyphicon-folder-open" style="font-size:45px; color: blue;"><a href="index.php?p=uploadacasp&placa=<?= $_GET['placa'] ?>&categoria=documentos"> Documentos </a></span></div>
        <div class="thumbnail col-md-3"> <span class="glyphicon glyphicon-folder-open" style="font-size:45px; color: blue;"><a href="index.php?p=uploadacasp&placa=<?= $_GET['placa'] ?>&categoria=contratos"> Contratos </a></span></div>
        <div class="thumbnail col-md-3"> <span class="glyphicon glyphicon-folder-open" style="font-size:45px; color: blue;"><a href="index.php?p=uploadacasp&placa=<?= $_GET['placa'] ?>&categoria=vitorias"> Vistorias </a> </span></div>
        <div class="thumbnail col-md-3"> <span class="glyphicon glyphicon-folder-open" style="font-size:45px; color: blue;"><a href="index.php?p=uploadacasp&placa=<?= $_GET['placa'] ?>&categoria=revistorias"> Re Vistorias</span></div>
...
?>
    ...
    <?php
    $enviados = new Read();
    $enviados->ExeRead("documentos", "WHERE id_venda = :p ", "p={$_GET['id_venda']}");
    $enviados->getResult();
