...
<section class="content"> 
    ...
    <form action="index.php?p=eusuariolider" name="buscar" method="POST" class="form" enctype="multipart-form/data"> 
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <tbody>
            ...
            if (isset($filtro)):
                ...
                $exibe = new Read();
                $exibe->ExeRead("usuario", "WHERE nivel = :p AND relacionado = :r ", "p={$filtro['nivel']}&r={$_COOKIE['logprot_id_usuario']}");
                $exibe->getResult();
          ...
          "
                ...
                $exibe = new Read();
                $exibe->ExeRead("usuario", "WHERE relacionado = :r ORDER BY id_usuario DESC" , "r={$_COOKIE['logprot_id_usuario']}");
                $exibe->getResult();
