...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=manutencao&ano={$ano}&mes={$mes}&dia={$dia}\"> ";
...
<main class="content"> 
    ...
    <section class="row col-md-12"> 
        <form action="index.php?p=manutencao" class="form" method="GET">
            ...
            <div class="col-md-2"> 
                ...
                <input type="submit" name="p" value="manutencao" class="btn btn-primary" /> </div>
            <div class="clear"> </div>
        </form>
    </section>
