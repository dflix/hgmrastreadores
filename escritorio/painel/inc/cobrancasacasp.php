...
<section class="col-md-2"> 
    ...
    <h2> COBRANÇAS CADASTRADAS ASSSOCIAÇÃO </h2>

    <?php
    if (isset($_GET['del'])):

        $del = new Delete();
        $del->ExeDelete("boletoscaixa", "WHERE id_boleto = :p", "p={$_GET['del']}");
        $del->getResult();
    ...
    if (isset($filtro['atualiza'])):
        ...
        $atualiza = new Update();
        $atualiza->ExeUpdate("boletoscaixa", $filtro, "WHERE id_boleto = :p", "p={$filtro['id_boleto']}");
        $atualiza->getResult();
