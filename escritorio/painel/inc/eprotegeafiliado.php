...
<section class="row"> 
        ...
        <div class="col-md-12"> 
            ...
            <form action="index.php?p=eprotegeafiliado" name="buscar" method="POST" class="form-responsive form-inline" enctype="multipart-form/data">
...
if (isset($filtro)) {
    ...
    <table class="table-responsive table-bordered ">
        ...
        <tbody>
            ...
            $pager = new Pager('index.php?p=eprotegeafiliado&atual=', 'Primeira', 'Ultima', '1');
    ...
    <table class="table-responsive table-bordered ">
        ...
        <tbody>
            ...
            if ($_COOKIE['logprot_nivel'] == "2" || $_COOKIE['logprot_nivel'] == "5" ):
                ...
                $exibe = new Read();
                $exibe->ExeRead("prevenda", "WHERE relacionado = :r ORDER BY data DESC LIMIT :limit OFFSET :offset", "r={$_COOKIE['logprot_id_usuario']}&limit={$pager->getLimit()}&offset={$pager->getOffset()}");
                $exibe->getResult();
