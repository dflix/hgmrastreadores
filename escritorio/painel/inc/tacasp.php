...
<main> 
    ...
    <h3>TRANSFERÊNCIA ASSOCIAÇÃO SÃO PAULO </h3>
    ...
    unset($form['nf2']);
    unset($form['marca_modelo1']);
    unset($form['ano1']);
    unset($form['cor1']);
    unset($form['renavam1']);
    unset($form['chassi1']);
    unset($form['placa1']);
    unset($form['empresa_rt1']);
    unset($form['valor1']);
    unset($form['alienado1']);
    unset($form['nf1']);
    unset($form['marca_modelo_t']);
    unset($form['ano_t']);
    unset($form['cor_t']);
...
?>
        ...
        <label class="cinquenta"> 
            ...
            <input type="text" name="valor_transf" class="form-control"   />
        </label>
        <label class="cinquenta"> 
            <p>Forma Pagamento da transferência </p>
            <input type="text" name="pgto_transf" class="form-control"   />
        </label>
        <label class="vinteecinco"> 
            <p>Assistencia 24hs </p>
            <input type="text" name="assist" class="form-control" value="<?php echo $form['assistencia24hs']; ?>"  />
        </label>
        <label class="vinteecinco"> 
        ...
        <label class="trintaetres"> 
            <p>Marca/Modelo </p>
            <input type="text" name="marca_modelo_t" class="form-control" value="<?= $ver->getResult()[0]['marca_modelo1']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Ano </p>
            <input type="text" name="ano_t" class="form-control" value="<?= $ver->getResult()[0]['ano1']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Cor </p>
            <input type="text" name="cor_t" class="form-control" value="<?= $ver->getResult()[0]['cor1']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Renavam </p>
            <input type="text" name="renavam_t" class="form-control" value="<?= $ver->getResult()[0]['renavam1']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Chassi </p>
            <input type="text" name="chassi_t" class="form-control" value="<?= $ver->getResult()[0]['chassi1']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Placa </p>
            <input type="text" name="placa_t" class="form-control" value="<?= $ver->getResult()[0]['placa1']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Empresa de Rastreamento </p>
            <input type="text" name="rt_t" class="form-control" value="<?= $ver->getResult()[0]['empresart_1']; ?>"  />
        </label>
        <label class="vinteecinco"> 
            <p>Valor Estimado </p>
            <input type="text" name="valor_t" class="form-control"  value="<?= $ver->getResult()[0]['valor1']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Alienado Por </p>
            <input type="text" name="alienado_t" class="form-control" value="<?= $ver->getResult()[0]['alienado1']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Nota Fiscal </p>
            <input type="text" name="nf_t" class="form-control" value="<?= $ver->getResult()[0]['nf1']; ?>" />
        </label>
        <div class="clear"> </div>

        <div class="clear"> </div>
        <h3>DADOS DO implemento </h3>

        <label class="trintaetres"> 
            <p>Marca/Modelo </p>
            <input type="text" name="marca_modelo_t" class="form-control" value="<?= $ver->getResult()[0]['marca_modelo2']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Ano </p>
            <input type="text" name="ano_t" class="form-control" value="<?= $ver->getResult()[0]['ano2']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Cor </p>
            <input type="text" name="cor_t" class="form-control" value="<?= $ver->getResult()[0]['cor2']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Renavam </p>
            <input type="text" name="renavam_t" class="form-control" value="<?= $ver->getResult()[0]['renavam2']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Chassi </p>
            <input type="text" name="chassi_t" class="form-control" value="<?= $ver->getResult()[0]['chassi2']; ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Placa </p>
            <input type="text" name="placa_t" class="form-control" value="<?= $ver->getResult()[0]['placa2']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Empresa de Rastreamento </p>
            <input type="text" name="rt_t" class="form-control" value="<?= $ver->getResult()[0]['empresart']; ?>"  />
        </label>
        <label class="vinteecinco"> 
            <p>Valor Estimado </p>
            <input type="text" name="valor_t" class="form-control"  value="<?= $ver->getResult()[0]['valor2']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Alienado Por </p>
            <input type="text" name="alienado_t" class="form-control" value="<?= $ver->getResult()[0]['alienado2']; ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Nota Fiscal </p>
            <input type="text" name="nf_t" class="form-control" value="<?= $ver->getResult()[0]['nf2']; ?>" />
        </label>
        <div class="clear"> </div>
        ...
        <h3>DADOS DO NOVO VEICULO (TRANSFERÊNCIA) </h3>

        <label class="trintaetres"> 
            <p>Marca/Modelo </p>
            <input type="text" class="form-control" name="marca_modelo1" value="<?= $newmarca ?> / <?= $modelo ?>"  />
        </label>
        <label class="trintaetres"> 
            <p>Ano </p>
            <input type="text" class="form-control" name="ano1" value="<?= $ano ?>" />
        </label>
        <label class="trintaetres"> 
            <p>Cor </p>
        ...
        <label class="trintaetres"> 
            <p>Renavam </p>
            <input type="text" class="form-control" name="renavam1"  />
        </label>
        <label class="trintaetres"> 
            <p>Chassi </p>
            <input type="text" class="form-control" name="chassi1"  />
        </label>
        <label class="trintaetres"> 
            <p>Placa </p>
            <input type="text" class="form-control" name="placa1" value="<?= $placa ?>"  />
        </label>
        <label class="vinteecinco"> 
            <p>Empresa de Rastreamento </p>
            <input type="text" class="form-control" name="empresart_1"  />
        </label>
        <label class="vinteecinco"> 
            <p>Valor Estimado </p>
            <input type="text" class="form-control" name="valor1" value="<?= $valorestimado ?>" />
        </label>
        <label class="vinteecinco"> 
            <p>Alienado Por </p>
        ...
        <label class="trintaetres">
            ...
            <select name="acao" class="form-control"> 
                <option value="1"> Somente Editar Dados </option>
                <option value="2"> Alterar Veiculos </option>
