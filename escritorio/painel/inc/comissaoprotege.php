...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=comissaoprotege&ano={$ano}&mes={$mes}&dia={$dia}&view=resultados\"> ";
...
<section class="row col-md-12"> 
        <form action="" class="form" metdod="GET">
            ...
            <div class="col-md-3"> 
                ...
                <input type="submit" name="p" value="comissaoprotege" class="btn btn-primary" /></div>
            <div class="clear"> </div>
        </form>
    </section>
        ...
        <?php 
          if (isset($_GET['ano'])):
                    ...
                    if ($_GET['dia'] == "mes"):
                        ...
                        $ver = new Read();
                        $ver->ExeRead("prevenda", "WHERE vendedor = :v AND  MONTH(data) = :m AND YEAR(data) = :a", "v={$_COOKIE['logprot_id_usuario']}&m={$mes}&a={$ano}");
                        $ver->getResult();
                    ...
                    //echo "Busca o mes e ano";
                        ...
                        $ver = new Read();
                        $ver->ExeRead("prevenda", "WHERE vendedor = :v AND  MONTH(data) = :m AND YEAR(data) = :a AND DAY(data) = :d", "v={$_COOKIE['logprot_id_usuario']}&m={$mes}&a={$ano}&d={$dia}");
                        $ver->getResult();
...
<section class="col-md-12"> 
    ...
    <h4>  Total de Comissões R$<?= number_format($total,2 , "." , ".") ?> </h4>
</section>
