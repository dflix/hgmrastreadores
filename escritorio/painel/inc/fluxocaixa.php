...
<main class="content"> 
    <h3 class="page-header"> Fluxo Caixa 
    ...
    <section class="col-md-12"> 
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            ?>><a href="#protege" role="tab" data-toggle="tab">ENTRADA PROTEGE</a></li>
            <li <?php
            if ($_GET['view'] == "acasp"): echo "class=\"active\"";
            endif;
            ?>><a href="#acasp" role="tab" data-toggle="tab">ENTRADA ACASP </a></li>
            <li <?php
            if ($_GET['view'] == "adesao"): echo "class=\"active\"";
            endif;
            ?>><a href="#adesao" role="tab" data-toggle="tab">ENTRADA ADESÃO & TRANSFERÊNCIAS </a></li>
            <li <?php
...
// var_dump($form);
            ...
            ?>" role="tabpanel" id="resultados">
                ...
                <table class="table-responsive table-striped table-bordered table-hover table-condensed col-md-12">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo "<h4>R$" . number_format($somaprotege / 100, 2, ".", ",") . "</h4>"; ?></td>
                            <td><?php echo "<h4>R$" . number_format($somaacasp / 100, 2, ".", ",") . "</h4>"; ?></td>
                            <td>
                                <?php
                                if ($_GET['dia'] == "mes"):

                                    $pxadesaoprotege = new Read();
                                    $pxadesaoprotege->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m", "p=4&a={$_GET['ano']}&m={$_GET['mes']}");
                                    $pxadesaoprotege->getResult();
                                    foreach ($pxadesaoprotege->getResult() as $value) {

                                        echo "R$" . number_format($value['valor'] / 100, 2, ".", ",") . " </br>";
                                        $adesaoprotege += $value['valor'];
                                    }
                                     echo "<h4> Total R$" . number_format($adesaoprotege / 100, 2, ".", ",") . "</h4>";
                                    ...
                                    $pxadesaoprotege = new Read();
                                    $pxadesaoprotege->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m AND DAY(data) = :d", "p=4&a={$GET['ano']}&m={$GET['mes']}&d={$GET['dia']}");
                                    $pxadesaoprotege->getResult();
                                    foreach ($pxadesaoprotege->getResult() as $value) {
                                        echo "R$" . number_format($value['valor'] / 100, 2, ".", ",") . " </br>";
                                        $adesaoprotege += $value['valor'];
                            ...
                            <td class="success">
                                ...
                                if ($_GET['dia'] == "mes"):
                                    ...
                                    $pxadesaoacasp = new Read();
                                    $pxadesaoacasp->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m", "p=6&a={$_GET['ano']}&m={$_GET['mes']}");
                                    $pxadesaoacasp->getResult();
                                    foreach ($pxadesaoacasp->getResult() as $valueaa) {

                                        echo "R$" . number_format($valueaa['valor'] / 100, 2, ".", ",") . " </br>";
                                        $adesaoacasp  += (int) $valueaa['valor'];
                                    }
                                     echo "<h4> Total R$" . number_format($adesaoacasp / 100, 2, ".", ",") . "</h4>";

                                else:

                                    $pxadesaoacasp = new Read();
                                    $pxadesaoacasp->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m AND DAY(data) = :d", "p=6&a={$GET['ano']}&m={$GET['mes']}&d={$GET['dia']}");
                                    $pxadesaoacasp->getResult();
                                    foreach ($pxadesaoacasp->getResult() as $valueaa) {
                                        echo "R$" . number_format($valueaa['valor'] / 100, 2, ".", ",") . " </br>";
                                        $adesaoacasp  += (int) $valueaa['valor'];
                            ...
                            <td class="success">
                                ...
                                if ($_GET['dia'] == "mes"):
                                    ...
                                    $pxtprotege = new Read();
                                    $pxtprotege->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m", "p=5&a={$_GET['ano']}&m={$_GET['mes']}");
                                    $pxtprotege->getResult();
                                    foreach ($pxtprotege->getResult() as $valueaa) {

                                        echo "R$" . number_format($valuetp['valor'] / 100, 2, ".", ",") . " </br>";
                                        $tprotege  += (int) $valuetp['valor'];
                                    }
                                     echo "<h4> Total R$" . number_format($tprotege / 100, 2, ".", ",") . "</h4>";

                                else:

                                    $pxtprotege = new Read();
                                    $pxtprotege->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m AND DAY(data) = :d", "p=5&a={$GET['ano']}&m={$GET['mes']}&d={$GET['dia']}");
                                    $pxtprotege->getResult();
                                    foreach ($pxtprotege->getResult() as $valuetp) {
                                        echo "R$" . number_format($valuetp['valor'] / 100, 2, ".", ",") . " </br>";
                                        $tprotege  += (int) $valuetp['valor'];
                                    }
                                   echo "<h4> Total R$" . number_format($tprotege / 100, 2, ".", ",") . "</h4>";
                            ...
                            <td class="success">
                                ...
                                if ($_GET['dia'] == "mes"):
                                    ...
                                    $pxtacasp = new Read();
                                    $pxtacasp->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m", "p=7&a={$_GET['ano']}&m={$_GET['mes']}");
                                    $pxtacasp->getResult();
                                    foreach ($pxtacasp->getResult() as $valueta) {

                                        echo "R$" . number_format($valueta['valor'] / 100, 2, ".", ",") . " </br>";
                                        $tacasp  += (int) $valueta['valor'];
                                    }
                                     echo "<h4> Total R$" . number_format($tacasp / 100, 2, ".", ",") . "</h4>";

                                else:

                                    $pxtacasp = new Read();
                                    $pxtacasp->ExeRead("caixa", "WHERE categoria = :p AND YEAR(data) = :a AND MONTH(data) = :m AND DAY(data) = :d", "p=7&a={$GET['ano']}&m={$GET['mes']}&d={$GET['dia']}");
                                    $pxtacasp->getResult();
                                    foreach ($pxtacasp->getResult() as $valueta) {
                                        echo "R$" . number_format($valueta['valor'] / 100, 2, ".", ",") . " </br>";
                                        $tacasp  += (int) $valueta['valor'];
                            ...
                            <td class="danger">
                             <?php
                                if ($_GET['dia'] == "mes"):
                                    ...
                                    $pxsaida = new Read();
                                    $pxsaida->ExeRead("caixa", "WHERE tipo = :p AND YEAR(data) = :a AND MONTH(data) = :m", "p=2&a={$_GET['ano']}&m={$_GET['mes']}");
                                    $pxsaida->getResult();
                                    foreach ($pxsaida->getResult() as $values) {

                                        echo "R$" . number_format($values['valor'] / 100, 2, ".", ",") . " </br>";
                                        $saida  += (int) $values['valor'];
                                    }
                                     echo "<h4> Total R$" . number_format($saida / 100, 2, ".", ",") . "</h4>";

                                else:

                                    $pxsaida = new Read();
                                    $pxsaida->ExeRead("caixa", "WHERE tipo = :p AND YEAR(data) = :a AND MONTH(data) = :m AND DAY(data) = :d", "p=2&a={$GET['ano']}&m={$GET['mes']}&d={$GET['dia']}");
                                    $pxsaida->getResult();
                                    foreach ($pxsaida->getResult() as $values) {
                                        echo "R$" . number_format($values['valor'] / 100, 2, ",", ".") . " </br>";
                                        $saida  += (int) $values['valor'];
                            ...
                            <td class="info">
                               ...
                               $totalentrada = $somaprotege + $somaacasp + $adesaoprotege + $adesaoacasp + $tprotege + $tacasp;
                               
                               echo number_format($totalentrada / 100 , 2 , ".", ",");
                                ...
                                <h3> TOTAL SAIDAS </h3>
                                R$ <?php 
                                echo number_format($saida / 100 , 2 , ".", ",");
                                ?>
                                
                                 <hr>
                                 <h3>Resultado </h3>
                                 <?php 
                                 $resultado = $totalentrada - $saida;
                                 echo number_format($resultado / 100 , 2 , ",", ".");
                                 ?>
