...
<?php
if (isset($_GET['del'])):
    echo "<p class=\"deletar\">Tem certeza que deseja remover esse registro <a href=\"index.php?p=eafiliado&delyes={$_GET['del']}\">clique aqui</a> </br>";
...
<!--    <h1 class="page-header"> BUSCAR </h1>
    ...
    <form action="index.php?p=eafiliado" name="buscar" method="POST" class="form" enctype="multipart-form/data"> 
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <tbody>
            ...
            if (isset($filtro)):
                ...
                $exibe = new Read();
                $exibe->ExeRead("usuario", "WHERE nivel = :p ", "p=5");
                $exibe->getResult();
          ...
          <td> {$exibestatus} </td>
            ...
            <td> <a href=\"index.php?p=eafiliado&del={$value['id_usuario']}\"><img src=\"img/deletar.png\" /></a></td></tr>
          ...
          "
                ...
                $exibe = new Read();
                $exibe->ExeRead("usuario", "WHERE nivel = :n AND relacionado = :r" , "n=5&r={$_COOKIE['logprot_id_usuario']}");
                $exibe->getResult();
