...
<main> 
    ...
    if ($form && $form['button']):
        ...
        if ($cadastra->getResult()) {
            ...
            echo "<p class=\"cadastro\">registro atualizado com sucesso</p>";
    ...
    <form id="form1" name="form1" method="post" action="">
        ...
        <label class="vinteecinco"><p>DATA NASCIMENTO</p>
            <input name="data_nasc" type="text" id="data_nasc" value="<?= $puxa->getResult()[0]['data_nasc'] ?>" size="10" onKeyPress="MascaraData(form.data_nasc)" />
        </label>
        ...
        <label class="vinteecinco">
            <p>TEL: Residencial.</p>
            <input name="telres" type="text" id="telres" value="<?= $puxa->getResult()[0]['telres'] ?>" onKeyPress="MascaraTelefone(form.telres)" size="12" />
        </label>
        <label class="vinteecinco">
            <p>TEL: Celular</p>
            <input name="telcel" type="text" id="telcel" value="<?= $puxa->getResult()[0]['telcel'] ?>" onKeyPress="MascaraTelefone(form.telcel)" size="12" />
        </label>
        <div class="clear"> </div>

        <label class="cem"><p>EMAIL:</p>
            <input name="email" type="text" id="email" value="<?= $puxa->getResult()[0]['email'] ?>" size="75" />
        </label>
        ...
        <label class="dez"><P>Numeroº</P>
            <input name="numero" type="text" value="<?= $puxa->getResult()[0]['numero'] ?>" id="numero"  />
        </label>
        <div class="clear"> </div>
        <label class="vinteecinco"> 
            <p>COMPLEMENTO:</p>
