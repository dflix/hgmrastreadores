...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=cancelamentos&ano={$ano}&mes={$mes}&dia={$dia}\"> ";
//header("location:index.php?p=fluxocaixa&ano={$ano}");
endif;
?>
<main class="content"> 
    <h3 class="page-header"> CANCELAMENTOS </h3>
    <section class="row col-md-12"> 
        <form action="index.php?p=cancelamento" class="form" method="GET">
            ...
            <div class="col-md-2"> 
                ...
                <input type="submit" name="p" value="cancelamento" class="btn btn-primary" /> </div>
            <div class="clear"> </div>
        </form>
    </section>
