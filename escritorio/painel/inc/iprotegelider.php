 ...
 //var_dump($form);
    ...
    <div class="col-md-12"> 
        ...
        <select name="vendedor" class="form-control">
            ...
            <?php 
            $selectvend = new Read();
            $selectvend->ExeRead("usuario", "WHERE  relacionado = :r ORDER BY id_usuario ASC", "r={$_COOKIE['logprot_id_usuario']}");
    ...
    <div class="page-header col-md-12">
        ...
        <div class="page-header">
            <h3> DADOS DO VEÍCULO <a href="index.php?p=iprotege&metodo=caminhoes" class="btn btn-info">ALTERAR  MÉTODO</a></h3> 
        </div>
