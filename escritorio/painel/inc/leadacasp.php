...
<div class="page-header">
    <h1> LEADS ASSOCIAÇÃO </h1>
      ...
      $exibe = new Read();
     $exibe->ExeRead("orcamentoacasp", "WHERE vendedor= :p ORDER BY id DESC LIMIT :limit OFFSET :offset" , "p={$_COOKIE['logprot_id_usuario']}&limit={$pager->getLimit()}&offset={$pager->getOffset()}");
      $exibe->getResult();
