...
<section class="col-md-8"> 
    ...
    if (isset($_GET['del'])):
        ...
        $del = new Delete();
        $del->ExeDelete("boletosantaner", "WHERE id_boleto = :p", "p={$_GET['del']}");
        $del->getResult();
    ...
    if (isset($filtro['atualiza'])):
        ...
        $atualiza = new Update();
        $atualiza->ExeUpdate("boletosantander", $filtro, "WHERE id_boleto = :p", "p={$filtro['id_boleto']}");
        $atualiza->getResult();
    ...
    <table class="table table-responsive table-bordered table-condensed">
        ...
        <tbody> 
            ...
            $cadastradas->ExeRead("boletosantander", "WHERE documento = :p ORDER BY parcela ASC", "p={$_GET['placa']}");
        ...
        EDITAR
                ...
                echo "<td> <a href=\"index.php?p=cobrancasacasp&placa={$_GET['placa']}&del={$value['id_boleto']}\" ><span class=\"glyphicon glyphicon-remove\" style=\"font-size:25px; color:red;\" > </a></td><tr>"
                ?>
