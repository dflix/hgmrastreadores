...
<main> 
    ...
    $enviar = new EnviaProtocoloAcasp();
    
                    $form['assunto'] = 'Protocolo de Atendimento Associação São Paulo';
                    $form['DestinoNome'] = 'contato@associacaosaopaulo.com.br';
    ...
    $cadastro = new Create();
    $cadastro->exeCreate("atendimentoacasp", $form);
    $cadastro->getResult();
