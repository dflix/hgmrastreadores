...
if (empty($_GET['ano'])):
    ...
    echo "<meta http-equiv=\"refresh\" content=1;url=\"index.php?p=guincho&ano={$ano}&mes={$mes}&dia={$dia}\"> ";
//header("location:index.php?p=fluxocaixa&ano={$ano}");
endif;
?>
<main class="content"> 
    <h3 class="page-header"> SOLICITAÇÃO DE GUINCHOS </h3>
    <section class="row col-md-12"> 
        <form action="index.php?p=guincho" class="form" method="GET">
            ...
            <div class="col-md-2"> 
                ...
                <input type="submit" name="p" value="guincho" class="btn btn-primary" /> </div>
            <div class="clear"> </div>
        </form>
    </section>
