...
<section class="col-md-12">
    ...
    <h2> BUSCAR COBRANÇAS SANTANDER </h2>
   ...
   // var_dump($filtro);
    ...
    <form action="" class="form" method="post"> 
        <div class="col-md-12"> 
            ...
            <input type="text" name="q" class="form-control" value="<?php if(isset($_GET['q'])):
                echo $_GET['q'];
            endif;
                 ?>" placeholder="BUSCA " />
        </div>
        <div class="col-md-12 form-inline"> 
             ...
             <div class="radio">
                        <label>
                            <input type="radio" name="filtro" value="cliente" <?php if(isset($_GET['q'])):
                echo "checked";
            endif;
                 ?> > NOME
                        </label>
...
<p> Placas encontrada <?= $valor['placa'] ?> </p>
...
<section class="col-md-6"> 
    ...
    <table class="table table-responsive table-bordered table-condensed">
        ...
        <tbody> 
            ...
            $cadastradas->ExeRead("boletosantander", "WHERE documento = :p ORDER BY parcela ASC", "p={$valor['placa']}");
                        ...
                        <div class="modal-body">
                            ...
                            <form action="" class="form" name="cobranca" method="get">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <input type="hidden"  name="placa" value="<?= $valor['placa'] ?>" />
