...
<!--        <div class="vinteecinco background"><span class="branquinho"> . </span>Alienado </div>
        <div class="vinteecinco background"><span class="branquinho"> . </span>Nota Fiscal </div>
        <div class="vinteecinco background"><span class="branquinho"> . </span>. </div>
        <div class="vinteecinco background"><span class="branquinho"> . </span> . </div>
        <div class="clear"> </div>
        <div class="vinteecinco"> <span class="branquinho"> . </span> <?= $ver->getResult()[0]['alienado']; ?> </div>
        <div class="vinteecinco"> <span class="branquinho"> . </span> <?= $ver->getResult()[0]['nf']; ?> </div>
        <div class="vinteecinco"> <span class="branquinho"> . </span> . </div>
        <div class="vinteecinco">  <span class="branquinho"> . </span>. </div>
        <div class="clear"> </div>-->

        <h1 class="contratoh1">ADESÃO </h1>

        <div class="cinquenta background"> <span class="branquinho"> . </span>Valor de Adesão </div>
        <div class="cinquenta background"> <span class="branquinho"> . </span>Pagamento Adesão </div>
        <div class="clear"> </div>
        <div class="cinquenta"> <span class="branquinho"> . </span> <?= $ver->getResult()[0]['adesao']; ?> </div>
        <div class="cinquenta"> <span class="branquinho"> . </span> <?= $ver->getResult()[0]['pgto_adesao']; ?> </div>
        <div class="clear"> </div>
