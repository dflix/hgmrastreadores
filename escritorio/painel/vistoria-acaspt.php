...
echo $nomevend->getResult()[0]['nome']; 
        ...
        <div class="vinteecinco background">Transferência</div>
        <div class="vinteecinco background">Pagamento da Transferencia</div>
        <div class="vinteecinco background">Data Adesão</div>
        <div class="clear"> </div>
        <div class="vinteecinco"> <?= $ver->getResult()[0]['contrato']; ?> </div>
        <div class="vinteecinco"> <?= $ver->getResult()[0]['valor_transf']; ?> </div>
        <div class="vinteecinco"> <?= $ver->getResult()[0]['pgto_transf']; ?> </div>
